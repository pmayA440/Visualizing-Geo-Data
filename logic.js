...
d3.json(url, function(response) {
    ...
    // For each event, create a marker and bind a popup with the name
        ...
        L.marker([earthquakeFeatures[i].geometry.coordinates[0], earthquakeFeatures[i].geometry.coordinates[1]]).bindPopup("<h1>" + "Location: " + earthquakeFeatures[i].properties.place + "<br>" + "Magnitude: " + earthquakeFeatures[i].properties.mag + "</h1>").addTo(myMap)
        );
    }
})
